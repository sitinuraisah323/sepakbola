...
// function chartOs() {
    ...
    $("#closemodal").on('click', function () {
        ...
        // const openModal = (date, units) => {
            ...
            const initDataTable = (date, units)=>{
          ...
          dataTable = $('#table-1').DataTable( {
                ...
                searching: true,
                ajax:  {
                    url: `<?php echo base_url();?>/api/transactions/pencairan/pencairan_bydate/${id_unit}/${date}`, 
...
// All OS
        ...
        data.forEach(item => {
            ...
            const template = index > -1 ? build[index] : {
                ...
                click: function(e) {
                        ...
                        window.open('<?php echo base_url();?>/transactions/pencairan/pencairan/' + date + '/' + units + '/' + selectBox + '/' + selectArea, '_blank');
    ...
    // AllNoa
    axios.get(`<?php echo base_url();?>/api/dashboard/getPencairan`).then(
        res => {
            const {
                data
            } = res.data;
...
function getArea(){
    ...
    var selectArea = $('#area_id').val();
    // AreaNoa
    axios.get(`<?php echo base_url();?>/api/dashboard/getPencairanArea/${selectArea}`).then(
        res => {
            const {
                data
            } = res.data;
...
function getCabang(){
    ...
    // UnitsNoa
    axios.get(`<?php echo base_url();?>/api/dashboard/getPencairanCabang/${selectArea}/${selectBox}`)
        .then(res => {
            const {
                data
            } = res.data;
    ...
    axios.get(`<?php echo base_url();?>/api/dashboard/getPencairanSelectUnits/${units}`).then(res => {
        const {
            data
        } = res.data;
        const build = [];
            ...
            item => {
                ...
                const reg = a > -1 ? reguler[a] : {
                    ...
                    click: function(e) {
                        ...
                        // 
                       window.open('<?php echo base_url();?>/monitoring/pencairan/detail/' + date + '/' + units, '_blank');
                        win.focus();
                    },
                    dataPoints: []
                }
